...
export class HlmCheckboxComponent {
  ...
  protected _computedClass = computed(() =>
    hlm(
      'group inline-flex border border-lime-500 rounded-md shrink-0 cursor-pointer items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring' +
