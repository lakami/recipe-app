...
export class HlmCheckboxComponent {
  ...
  protected _computedClass = computed(() =>
    hlm(
      'group inline-flex border border-lime-500 rounded-none shrink-0 cursor-pointer items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring' +
      ' focus-visible:ring-offset-2 focus-visible:ring-offset-background data-[state=checked]:text-background data-[state=checked]:bg-lime-500 data-[state=unchecked]:bg-background',
      this.userClass(),
