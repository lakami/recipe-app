    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(mvc.pattern(POST, "/api/v1/promoted/**")).hasAnyAuthority(ADMIN)
                        .requestMatchers(mvc.pattern(DELETE, "/api/v1/promoted/**")).hasAnyAuthority(ADMIN)
                        .requestMatchers(mvc.pattern(GET, "/api/v1/promoted/**")).permitAll()
                        .requestMatchers(mvc.pattern(GET, "/api/v1/promoted")).permitAll()
